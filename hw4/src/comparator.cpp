...
int evaluateTeamCppSkill(const ProjectTeam* team) {
    return team->cppSkillSum();
}
...
int evaluateTeamGdbSkill(const ProjectTeam* team) {
    return team->gdbSkillSum();
}
...
int evaluateTeamAlgoSkill(const ProjectTeam *team) {
    return team->algoSkillSum();
}
